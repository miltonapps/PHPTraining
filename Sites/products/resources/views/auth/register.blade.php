...
<div class="row main-frame">
    ...
    <div class="col-md-4 dark-background">
            ...
            <div class="vertical-center">
                <div class="container">
                    <div class="side-head side-text">{{ __('Already a member?') }}</div>
                    <div class="side-text">{{ __('Then welcome back') }}</div>
                    <div class="col-md-10 offset-md-1 form-group">
                            <a class="btn side-btn form-control" href="{{ route('login') }}">{{ __('Sign In') }}</a>
