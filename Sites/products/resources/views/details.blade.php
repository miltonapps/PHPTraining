    ...
    <div class="products-grid row">
        ...
        <div class="right-panel col-md-auto card">
            ...
            <div class="price-box">
                ...
                <div class="price-bar">
                    <button id='price1-' class='down_count btn qty-btn' title='Down'>-</i></button>
                    <input id='price1-counter' class='counter' type="text" placeholder="value..." value='0' />
                    <button id='price1+' class='up_count btn qty-btn' title='Up'>+</button>
                </div>
            </div>
            <div class="price-box">
                <div class="uom">
                ...
                <div class="price-bar">
                    <button id='price2-' class='down_count btn qty-btn' title='Down'>-</i></button>
                    <input id='price2-counter' class='counter' type="text" placeholder="value..." value='0' />
                    <button id='price2+' class='up_count btn qty-btn' title='Up'>+</button>
                </div>
            </div>
            ...
            <div class="price-box">
                ...
                <div class="price-bar">
                    <button id='price3-' class='down_count btn qty-btn' title='Down'>-</i></button>
                    <input id='price3-counter' class='counter' type="text" placeholder="value..." value='0' />
                    <button id='price3+' class='up_count btn qty-btn' title='Up'>+</button>
                </div>
            </div>
